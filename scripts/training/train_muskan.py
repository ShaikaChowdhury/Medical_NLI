"""
Train the MUSKAN model on the preprocessed MedNLI dataset.
"""
...
def main(train_file,
    ...
    Args:
        ...
        hidden_size: The size of the hidden layers in the model. Defaults
            to 768.
        bilstm_size: The size of the hidden units of the bilstm. Defaults
            to 384.    
    ...
    with open(train_file, "rb") as pkl:
        train_data = MedNLI(pickle.load(pkl))

    train_loader = DataLoader(train_data, shuffle=True, batch_size=batch_size)

    print("\t* Loading validation data...")
    with open(valid_file, "rb") as pkl:
        valid_data = MedNLI(pickle.load(pkl))
    ...
    model = MUSKAN(
                 ...
                 bilstm_size,
                 train_data.sem_emb,
                 train_data.max_hypothesis_length,
                 dropout=dropout,
    ...
    print("\n",
          20 * "=",
          "Training MUSKAN model on device: {}".format(device),
          20 * "=")
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        if epoch_accuracy < best_score:
            ...
            # training from the best model, use the 'muskan_*.pth.tar'
            # checkpoints instead.
        ...
        torch.save({"epoch": epoch,
                    ...
                    "train_losses": train_losses,
                    "valid_losses": valid_losses},
                   os.path.join(target_dir, "muskan_{}.pth.tar".format(epoch)))
...
if __name__ == "__main__":
    default_config = "../../config/training/muskan_training.json"

    parser = argparse.ArgumentParser(description="Train the MUSKAN model on MedNLI")
